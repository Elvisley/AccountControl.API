...
namespace AC.Persistence.Migrations
{
    ...
    [Migration("20180923140045_ACAlterTransactionColumnNullable")]
    partial class ACAlterTransactionColumnNullable
    {
            ...
            modelBuilder.Entity("AC.Domain.Transactions", b =>
                {
                    ...
                    b.HasIndex("AccountDestinationId")
                        .IsUnique()
                        .HasFilter("[ACCOUNT_DESTINATION_ID] IS NOT NULL");

                    b.HasIndex("AccountSourceId")
                        .IsUnique()
                        .HasFilter("[ACCOUNT_SOURCE_ID] IS NOT NULL");
            ...
            modelBuilder.Entity("AC.Domain.Transactions", b =>
                {
                    b.HasOne("AC.Domain.Account", "AccountDestination")
                        .WithOne()
                        .HasForeignKey("AC.Domain.Transactions", "AccountDestinationId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AC.Domain.Account", "AccountSource")
                        .WithOne()
                        .HasForeignKey("AC.Domain.Transactions", "AccountSourceId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AC.Domain.TransactionsType", "TransactionType")
                        .WithOne()
                        .HasForeignKey("AC.Domain.Transactions", "TransactionTypeId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
